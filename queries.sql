...
-- show all users with their followers and following number
select
    user.user_id,
    user.first_name,
...
-- each user full name with his eduction, country, and city
select
...
-- Is there any posts that talks about topics differ from community main topic?
select
